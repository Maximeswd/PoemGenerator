...
class PoetryGenerator:
    ...
    def _build_model(self, total_words, max_sequence_len):
        model = Sequential()
        model.add(Embedding(total_words + 1, 512, input_length=max_sequence_len - 1))
    ...
    def generate_poetry(self, mood, num_words=25):
        prompts = {
        ...
        seed_text = random.choice(prompts[mood])
...
pg.train_model(epochs=20)

# Generate a poem given a mood
poem = pg.generate_poetry(mood='happy', num_words=25)
print(poem)
